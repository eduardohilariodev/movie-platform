    ...
    <Tooltip>
      <TooltipTrigger asChild>
        <ScButton
          ...
          :class="[
            {
              'aspect-square size-10 rounded-full': rounded && !label,
              'rounded-md': label && !rounded,
              'bg-white text-black hover:bg-neutral-100 dark:bg-neutral-100 dark:text-neutral-950 dark:hover:bg-neutral-200':
                variant === 'default',
